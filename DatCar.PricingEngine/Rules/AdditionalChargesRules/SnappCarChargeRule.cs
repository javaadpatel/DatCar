...
{
    /// <summary>
    /// This rule allows for charging a percentage for SnappCar fees
    /// </summary>
    public class SnappCarChargeRule : PercentageChargeRule
    {
        public SnappCarChargeRule() : base("SnappCar", 10m)
        {
        }
    }
}
